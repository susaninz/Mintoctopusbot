...
"""
    ...
    def create_fantasy_description(self, original_text: str, extracted_data: Dict) -> str:
        ...
        prompt = f"""
Перепиши описание мастера в стиле мудрого Осьминога - хранителя волшебного заповедника. 
...
1. Передает суть услуг мастера, но в магическом стиле
2. Сохраняет важную информацию о практиках
3. Упоминает заповедник и его тайные места
4. Звучит мудро и загадочно, но тепло

Примеры стиля:
- "В глубинах заповедника, где древние камни хранят секреты исцеления..."
- "Среди щупалец мудрости этот мастер обнаружил дар..."
- "В тёплых водах бани сокрыты знания..."

Не используй слова "волшебный", "магический" слишком часто. Пиши от третьего лица.
"""
